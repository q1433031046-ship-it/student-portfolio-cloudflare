...
test('same pinned template produces complete local files and rejects truncated media', async () => {
  ...
  const data = { ...manualDocument(draft, [row]), template, adminOrigin: 'https://student-portfolio.q1433031046.workers.dev', headers: '/*\n  X-Content-Type-Options: nosniff\n' };
  ...
  assert.ok(html.includes('https://student-portfolio.q1433031046.workers.dev/admin'));
